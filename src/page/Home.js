...
const Home = () => {
  return (
    <>
      ...
      <section className="bg-[#1a1a1a] px-exploreinline pt-20 flex items-center discover-container">
        <div className="grid">
        ...
        <div className="w-exploreh2width ps-explorestart">
          ...
          <button className="uppercase text-white bg-[#030304] bg-opacity-50 border-white border border-opacity-50 px-6 py-3 rounded-3xl tracking-wide mt-4 text-discoverBtn font-rubik">Discover more about me</button>
        </div>
      </section>
      <Alt />
      <Testimonial />
