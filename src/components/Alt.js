...
const Alt = () => {
  return (
    <section className="bg-[#1a1a1a] px-inlinepadding alt-container py-16 max-[660px]:px-mobileinlinepadding max-[660px]:gap-0">
      <h2 className="text-white text-center font-bold font-syne pb-6 text-[56px]">&lt; alt &gt;</h2>
      <div className="grid grid-cols-threeColumns gap-[1.625rem] max-[660px]:flex">
