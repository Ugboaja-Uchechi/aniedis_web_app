...
const Testimonial = () => {
  return (
    <section className="bg-[#1a1a1a] flex justify-between px-12 py-20 testimonial-container max-[660px]:px-mobileinlinepadding max-[660px]:flex-col max-[660px]:pt-12">
